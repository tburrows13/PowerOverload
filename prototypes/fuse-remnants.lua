...
small_fuse_remnants.animation_overlay = {
  filename = "__PowerOverload-fork__/graphics/entity/small-electric-fuse/small-fuse-remnants.png",
  line_length = 1,
  width = 80,
  height = 207,
  frame_count = 1,
...
small_fuse_remnants.animation = {
  filename = "__PowerOverload-fork__/graphics/entity/small-electric-fuse/small-fuse-remnants-shadow.png",
  line_length = 1,
  width = 266,
  height = 56,
  frame_count = 1,
...
medium_fuse_remnants.animation_overlay = {
  filename = "__PowerOverload-fork__/graphics/entity/medium-electric-fuse/medium-fuse-remnants.png",
  line_length = 1,
  width = 68,
  height = 163,
  frame_count = 1,
...
medium_fuse_remnants.animation = {
  filename = "__PowerOverload-fork__/graphics/entity/medium-electric-fuse/medium-fuse-remnants-shadow.png",
  line_length = 1,
  width = 190,
  height = 44,
  frame_count = 1,
...
big_fuse_remnants.animation_overlay = {
  filename = "__PowerOverload-fork__/graphics/entity/big-electric-fuse/big-fuse-remnants.png",
  line_length = 1,
  width = 111,
  height = 161,
  frame_count = 1,
...
big_fuse_remnants.animation = {
  filename = "__PowerOverload-fork__/graphics/entity/big-electric-fuse/big-fuse-remnants-shadow.png",
  line_length = 1,
  width = 192,
  height = 78,
  frame_count = 1,
