...
local function update_global_settings()
    ...
    for _, setting in pairs({"power-overload-disconnect-different-poles", "power-overload-on-pole-overload",
                             "power-overload-log-to-chat", "power-overload-transformer-efficiency"}) do
